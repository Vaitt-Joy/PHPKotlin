package com.evergrande.lib.utils.android.net;
...
import com.evergrande.lib.utils.java.lang.reflect.ReflectUtils;
...
public class NetworkUtils {
    ...
    public static boolean setMobileNetwork(Context context, boolean eanble) {
        ...
        Method method = getMethod(mConnectivityManager.getClass(), "setMobileDataEnabled", boolean.class);
        try {
            if (method != null) {
