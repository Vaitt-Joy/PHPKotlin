package com.evergrande.lib.cameraLib.api21;
...
public class Camera2 extends CameraViewImpl {
    ...
    public boolean isZoomSupported() {
        float[] floats = mCameraCharacteristics.get(CameraCharacteristics.LENS_INFO_AVAILABLE_FOCAL_LENGTHS);
    ...
    public int getMaxZoom() {
        Float aFloat = mCameraCharacteristics.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM);
        if (aFloat == null)
            return 0;
    ...
    void updateZoom() {
        ...
        if (mZoom <= 0)
            mZoom = 0;
        else if (mZoom >= maxZoom)
            mZoom = maxZoom;
        mPreviewRequestBuilder.set(CaptureRequest.LENS_FOCAL_LENGTH, (float) mZoom);
    }
